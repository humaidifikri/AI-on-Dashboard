...
# def get_user_data_summary(username=None):
#     """
#     Get a summary of user's data including total records, date range, etc.
#     """
#     if username is None:
#         if 'username' in st.session_state and st.session_state.username:
#             username = st.session_state.username
...
#         "date_range": f"{data['tanggal'].min().strftime('%Y-%m-%d')} to {data['tanggal'].max().strftime('%Y-%m-%d')}",
#         "latest_record": data['tanggal'].max().strftime('%Y-%m-%d')
#     }
...
# def load_data():
#     data = pd.read_csv('data/weight_track.csv')
#     data['tanggal'] = pd.to_datetime(data['tanggal'])
#     return data

# def load_filtered_data(start_date=None, end_date=None, filter_tgl="Hari"):
#     data = pd.read_csv('data/weight_track.csv')
#     data['tanggal'] = pd.to_datetime(data['tanggal'])
